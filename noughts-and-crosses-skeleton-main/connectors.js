...
function positionClick(rowIndex, columnIndex, event) {
    ...
    if (winner) {
        // if (typeof winner !== "string" || !["noughts", "crosses", "nobody"].includes(winner)) {
           if (typeof winner !== "string" || !["moon", "star", "nobody"].includes(winner)) {
            throw "Expecting 'checkWinner' to return null or one of the strings 'moon', 'star' or 'nobody'. Actually received: " + winner;
        }
